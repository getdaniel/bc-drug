...
# aromatase structure
st.write("The goal of this project is finding best chemical with higher Potency(Having higher pIC50 value) to break the below structure of Aromatase Enzyme")
aromatase_structure()
