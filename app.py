...
# aromatase structure
st.markdown("<h2 style='text-align: center;'>#### The goal of this project is finding best chemical with higher Potency(Having higher pIC50 value) to break the below structure of Aromatase Enzyme</h2>")
aromatase_structure()
